...
public class UsuarioService {
    ...
    public List<AdminUsuarioDTO> obtenerTodosLosUsuariosAdmin() {
        return usuarioRepository.findAll()
                .stream()
                .map(this::mapearAAdminUsuarioDTO)
                .collect(Collectors.toList());
    }

    public AdminUsuarioDTO actualizarUsuarioAdmin(Long idUsuario, String rol, Boolean activo) {
        Usuario usuario = obtenerUsuarioEntidad(idUsuario);
        ...
        return mapearAAdminUsuarioDTO(usuario);
    }

    private AdminUsuarioDTO mapearAAdminUsuarioDTO(Usuario usuario) {
        ...
        dto.setIdDepartamento(
                usuario.getDepartamento() != null ? usuario.getDepartamento().getIdDepartamento() : null
        );
        return dto;
    }
}
