...
export class NuevoGastoDialogComponent implements OnInit {
  ...
  private imagenNombreBackend: string | null = null;
    ...
    forkJoin({
      ...
      next: (result) => {
        ...
        if (result.drive) {
          ...
          this.imagenNombreBackend = result.drive.imagenNombre;
        }
  ...
  onSubmit(): void {
    ...
    if (this.driveFileId) {
      ...
      gasto.imagenNombre = this.imagenNombreBackend || this.selectedFileName;
    }
